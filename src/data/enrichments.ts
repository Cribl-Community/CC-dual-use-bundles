export interface EnrichmentFunctionConfig {
  function: string;
  inputField?: string;
  [key: string]: unknown;
}

export interface EnrichmentImplementation {
  functionConfig?: EnrichmentFunctionConfig;
  example: string;
  notes: string;
  [key: string]: unknown;
}
...
export interface Enrichment {
  name: string;
  description: string;
  criblFunction: string;
  addedFields: string[];
  securityValue: string;
  observabilityValue?: string;
  personas: string[];
  implementation: EnrichmentImplementation;
}

export interface EnrichmentSet {
  streamTime: Enrichment[];
  searchTime?: Enrichment[];
}

export const enrichments: Record<string, EnrichmentSet> = {
  'palo-alto-traffic': {
    streamTime: [
      {
